...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="❒ ๓ēຖน ❒", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="❒ ຖēxt ❒", callback_data=f"dilXaditi")]
...
def second_page(_):
	controll_button = [InlineKeyboardButton(text="☒ ๖ค¢k ☒", callback_data=f"settings_back_helper")]
